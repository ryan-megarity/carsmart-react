...
const Home = (props: { handleShow: any }) => {
    const mapsIframe =
        '<iframe width="80%"frameborder="0" style="border:0" src="https://www.google.com/maps/embed/v1/search?key=AIzaSyBBV401KxB3kbXOzRUTI6yOK-rg6EGLJj8&q=Carsmart+Oxford+Unit+2+Frogs+Island+Old+Didcot+Road+OX10+0SW" allowfullscreen></iframe>';
